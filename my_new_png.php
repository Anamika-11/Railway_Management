...
echo "HI,here's your ticket details<br><br>";
//print_r($result);
...
// echo "Name of the passenger:".$tpname[0]."<br><br>";
// echo "Age of the passenger:".$tpage[0]."<br><br>";
// echo "Gender of the passenger:".$tpgender[0]."<br><br>";

for($i=0;$i<$_SESSION["nos"];$i++) 
{
    echo "Name of the passenger:".$tpname[$i]."<br><br>";
echo "Age of the passenger:".$tpage[$i]."<br><br>";
echo "Gender of the passenger:".$tpgender[$i]."<br><br>";
...
echo "<br><br><a href=\"http://localhost/railway/indexcopy.htm\">Go Back!!!</a> <br>";

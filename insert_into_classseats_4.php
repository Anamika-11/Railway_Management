...
{
	if($_POST["s1".$temp]>0)
	{$sql = "INSERT INTO newclassseats (trainno,sp,dp,doj,class,seatsleft) VALUES ('".$_SESSION["trainno"]."','".$_SESSION["st".$temp]."','".$_SESSION["st".($temp+1)]."','".$_SESSION["doj"]."','AC','".$_POST["s1".$temp]."')";
	$flag=($conn->query($sql));
	}
	// if($_POST["s2".$temp]>0)
	...
	//}
	if($_POST["s2".$temp]>0)
	{$sql = "INSERT INTO newclassseats (trainno,sp,dp,doj,class,seatsleft) VALUES ('".$_SESSION["trainno"]."','".$_SESSION["st".$temp]."','".$_SESSION["st".($temp+1)]."','".$_SESSION["doj"]."','SL','".$_POST["s2".$temp]."')";
	$flag=($conn->query($sql));
	}

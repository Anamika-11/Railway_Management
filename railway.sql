...
--
CREATE TABLE IF NOT EXISTS `newtrain` (
  `trainno` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Train_no',
  `tnumber` varchar(50) NOT NULL COMMENT 'Train_number',
  `sp` varchar(50) NOT NULL COMMENT 'Starting_Point',
  -- `st` time NOT NULL COMMENT 'Arrival_Time',
  `dp` varchar(50) NOT NULL COMMENT 'Destination_Point',
  -- `dt` time NOT NULL,
  `dtrav` varchar(10) DEFAULT NULL COMMENT 'Date_of_travel',
  `ac` int(11) NOT NULL COMMENT 'No_of_ac',
  `sl` int(11) NOT NULL COMMENT 'No_of_sleeper',
  PRIMARY KEY (`tnumber`),
  --KEY `sp` (`sp`),
  --KEY `dp` (`dp`)

...
echo " <table><thead><td>Starting Point</td><td>Destination Point</td><td>AC seats</td><td>SL seats</td></thead>";
...
{
echo "
<form action=\"insert_into_newclassseats_3.php\" method=\"post\">
<table>
